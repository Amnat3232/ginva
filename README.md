...
- มีเวลา 72 ชั่วโมงก่อนมีอะไรเกิดขึ้น _(เฉพาะกรณีครบกำหนดคืนเงิน)_
...
| ยึดทรัพย์ทันทีทุกกรณี   | **72 ชม. ก่อนล้าง** _(ครบกำหนด)_ |
...
## 🛡️ ระบบปกป้อง 72 ชั่วโมง (เฉพาะครบกำหนดคืนเงิน)
...
**⚠️ ข้อยกเว้นสำคัญ:** หากหลักประกันมีมูลค่าต่ำกว่าเงินกู้ (Health Factor < 100%) ระบบจะล้างทันทีเพื่อปกป้องเงินทุนของนักลงทุน

**ไม่มีการยึดทรัพย์กลางดึกจากการครบกำหนด**
