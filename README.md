...
| ยึดทรัพย์ทันทีทุกกรณี   | **72 ชม. ก่อนล้าง** _(เฉพาะครบกำหนด)_ |
| ซับซ้อน งง              | **เรียบง่าย ใช้ง่าย**                 |
| ไม่มีระบบสะสมนิรภัย     | **Exit Fee 5% ถ้าถอนก่อน 15 วัน**     |
...
| **ระยะปกป้อง**   | 72 ชั่วโมง (เฉพาะครบกำหนด) |
| **LTV Safe**     | 20%                        |
| **LTV Standard** | 40%                        |
| **LTV Max**      | 60%                        |
| **Deposit Fee**  | Configurable (ช่วง 0-2.5%) |
| **Exit Fee**     | 5% (ถอนก่อน 15 วัน)        |
